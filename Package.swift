...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/realm/SwiftLint.git", exact: "0.59.0")
    ],
    targets: [
        .target(name: "Secp256k1Renamed", dependencies: ["secp256k1_bindings"]),
